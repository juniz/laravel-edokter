            ...
            <Link href="/" className="flex items-center gap-2">
              {companyLogo ? (
                <>
                  ...
                  <span className="font-bold text-xl hidden sm:inline-block">{companyName}</span>
                </>
              ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-muted-foreground max-w-sm">
                Solusi hosting terbaik untuk bisnis Anda. Performa tinggi, keamanan terjamin, dan dukungan 24/7.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>
                  <Link href={route('catalog.guest')} className="hover:text-foreground transition-colors">
                    Shared Hosting
                  </Link>
                </li>
                <li>
