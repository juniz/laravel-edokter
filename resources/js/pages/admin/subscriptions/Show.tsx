    ...
    <AppLayout breadcrumbs={breadcrumbs}>
      ...
      <div className="flex flex-col gap-6 p-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {subscription.panelAccount && (
            <Card className="bg-white dark:bg-gray-800 shadow-md">
              <CardHeader>
                <CardTitle>Panel Account</CardTitle>
              </CardHeader>
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">Username</span>
                  <span className="font-semibold">{subscription.panelAccount.username}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">Domain</span>
                  <span>{subscription.panelAccount.domain}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600 dark:text-gray-400">Status</span>
                  <Badge>{subscription.panelAccount.status}</Badge>
                </div>
              </CardContent>
            </Card>
          )}
