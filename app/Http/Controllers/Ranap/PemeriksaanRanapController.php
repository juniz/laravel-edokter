...
class PemeriksaanRanapController extends Controller
{
    ...
    public function postPemeriksaan(Request $request)
    {
        ...
        $data = [
            ...
            'suhu_tubuh' => Request::get('suhu') ?? 'Na',
            'tensi' => Request::get('tensi') ?? 'Na',
            'nadi' => Request::get('nadi') ?? 'Na',
            'respirasi' => Request::get('respirasi') ?? 'Na',
            'tinggi' => Request::get('tinggi') ?? 'Na',
            'berat' => Request::get('berat') ?? 'Na',
            'gcs' => Request::get('gcs') ?? 'Na',
