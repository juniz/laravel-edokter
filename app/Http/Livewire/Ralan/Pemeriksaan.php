...
class Pemeriksaan extends Component
{
    ...
    public function getStatistikPemeriksaan()
    {
        ...
        $tandaVital = DB::table('pemeriksaan_ralan')
            ->where('no_rawat', $this->noRawat)
        ...
        $distribusiDokter = DB::table('pemeriksaan_ralan')
            ->join('pegawai', 'pemeriksaan_ralan.nip', '=', 'pegawai.nik')
            ->where('pemeriksaan_ralan.no_rawat', $this->noRawat)
        ...
        $pemeriksaanPerHari = DB::table('pemeriksaan_ralan')
            ->where('no_rawat', $this->noRawat)
        ...
        $avgTensi = DB::table('pemeriksaan_ralan')
            ->where('no_rawat', $this->noRawat)
            ->whereNotNull('tensi')
            ->where('tensi', '<>', 'Na')
        ...
        $avgNadi = DB::table('pemeriksaan_ralan')
            ->where('no_rawat', $this->noRawat)
            ->whereNotNull('nadi')
            ->where('nadi', '<>', 'Na')
        ...
        $avgSuhu = DB::table('pemeriksaan_ralan')
            ->where('no_rawat', $this->noRawat)
        ...
        $avgSpo2 = DB::table('pemeriksaan_ralan')
            ->where('no_rawat', $this->noRawat)
            ->whereNotNull('spo2')
            ->where('spo2', '<>', 'Na')
